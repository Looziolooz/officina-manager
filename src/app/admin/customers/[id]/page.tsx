    ...
    <div className="p-6 max-w-7xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white/5 border border-white/10 p-6 rounded-2xl">
          ...
          <p className="text-3xl font-mono font-bold text-green-400">€ {(customer.totalSpent ?? 0).toFixed(2)}</p>
        </div>
        <div className="bg-white/5 border border-white/10 p-6 rounded-2xl">
          <div className="flex items-center gap-3 mb-2 text-gray-400">
          ...
          <p className="text-3xl font-mono font-bold text-blue-400">€ {(customer.totalMargin ?? 0).toFixed(2)}</p>
        </div>
        <div className="bg-white/5 border border-white/10 p-6 rounded-2xl">
          <div className="flex items-center gap-3 mb-2 text-gray-400">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {customer.vehicles.map(vehicle => (
                <div key={vehicle.id} className="bg-slate-900 border border-white/10 p-5 rounded-2xl group hover:border-primary/50 transition-colors">
                  ...
                  <p className="text-white font-bold text-lg">{vehicle.brand} {vehicle.modelName}</p>
