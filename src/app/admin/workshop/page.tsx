      ...
      <div className="flex justify-between items-center shrink-0">
        ...
        <div className="flex gap-3">
          <Link
            ...
            className="bg-primary hover:bg-primary-hover text-white px-4 py-2 rounded-xl font-bold flex items-center gap-2 transition-all shadow-lg shadow-red-900/20"
          >
            <Plus size={20} />
            Nuovo Lavoro
          </Link>
