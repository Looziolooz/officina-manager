          ...
          {session ? (
            <Link
              href="/admin/dashboard"
                className="flex items-center gap-2 bg-primary text-white px-4 py-2 rounded-lg font-bold hover:bg-primary-hover transition-all text-xs uppercase"
            >
          ...
          >
            <div className="flex flex-col p-6 gap-4">
              ...
              <Link
                ...
                onClick={() => setIsOpen(false)}
                  className="flex items-center justify-center gap-2 bg-primary text-white py-3 rounded-lg font-bold mt-2 hover:bg-primary-hover transition-all"
              >
                <UserLock size={18} />
