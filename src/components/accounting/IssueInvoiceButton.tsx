...
export default function IssueInvoiceButton({ jobId, hasInvoice }: Props) {
  ...
  return (
    <button
      ...
      disabled={isLoading}
      className="bg-primary hover:bg-primary-hover text-white text-xs px-3 py-1.5 rounded-lg font-bold flex items-center gap-2 transition-all shadow-lg shadow-red-900/20 disabled:opacity-50"
    >
